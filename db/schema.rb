...
ActiveRecord::Schema.define(version: 20170416073230) do
  ...
  create_table "businesses", force: :cascade do |t|
    ...
    t.index ["name", "address1", "address2"], name: "index_businesses_on_name_and_address1_and_address2", unique: true, using: :btree
